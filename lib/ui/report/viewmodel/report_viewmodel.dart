...
class ReportViewModel extends ChangeNotifier {
  ...
  Future<void> _fetchReport() async {
    try {
      ...
      _orderTypePercentages = await _repository.getOrderTypePercentages(
        start,
        end,
      );
    } catch (e) {
...
class MockReportRepository implements ReportRepository {
  ...
  Future<Map<String, int>> getOrderTypePercentages(
    ...
    return {'Dine-in': 55, 'Take-away': 30, 'Delivery': 15};
  }
    ...
    return [
      {
        ...
        'percentage': 45, // revenue share
        'unitsSold': 38,
        'imagePath': null,
      },
      {
        'name': 'Lamb Over Rice',
        'percentage': 30, // revenue share
        'unitsSold': 21,
        'imagePath': null,
      },
      {
        'name': 'Soda Can',
        'percentage': 15, // revenue share
        'unitsSold': 64,
        'imagePath': null,
      },
      {
        'name': 'Falafel Wrap',
        'percentage': 10, // revenue share
        'unitsSold': 12,
        'imagePath': null,
      },
    ];
